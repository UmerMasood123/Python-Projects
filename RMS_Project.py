...
#,bg="#03C04A"
    ...
    def __init__(self,root):
        ...
        self.root.title("Retail Biling System")
        self.root.resizable(False, False)
        bg_color="#0BB5FF"
        title=Label(self.root,text="RETAIL BILING SYSTEM",bd=10,relief=GROOVE,bg=bg_color,fg="#003151",font=("times new roman",30,"bold"),pady=2).pack(fill=X)
        #=====var====
        #====juices======
        self.sprite=IntVar()
